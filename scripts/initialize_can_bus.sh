...
sudo ip link set can2 type can bitrate 1000000 sample-point 0.867
sudo ip link set can3 type can bitrate 1000000 sample-point 0.867
sudo ip link set can4 type can bitrate 1000000 sample-point 0.867
sudo ip link set can5 type can bitrate 1000000 sample-point 0.867
